...
export function LoginScreen() {
  ...
  const entrar = () => {
    ...
    // sucesso: o AppShell reage à mudança de sessão e libera o app.
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--navy-deep)] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="surface rounded-2xl p-6 space-y-4">
          ...
          <form onSubmit={(e) => { e.preventDefault(); entrar(); }} className="space-y-3">
            <div>
              <div className="text-[11px] text-muted-foreground mb-1.5">Usuário</div>
              <input autoFocus className={inputCls} value={usuario} onChange={(e) => { setUsuario(e.target.value); setErro(""); }} placeholder="seu usuário" autoComplete="username" />
            </div>
            <div>
            ...
            <GoldButton type="submit" className="w-full justify-center" onClick={entrar}>Entrar</GoldButton>
          </form>
        </div>
